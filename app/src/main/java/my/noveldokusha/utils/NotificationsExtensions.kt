...
fun NotificationCompat.Builder.setLargeIcon(id: Int) =
    setLargeIcon(BitmapFactory.decodeResource(App.instance.resources, id))

fun NotificationCompat.Builder.close(context: Context, channel_id: String) =
    manager(context).cancel(channel_id.hashCode())

fun NotificationCompat.Builder.showNotification(
    channel_id: String,
    builder: NotificationCompat.Builder.() -> Unit
) = run {
    builder(this)
