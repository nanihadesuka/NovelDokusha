...
var SharedPreferences.SOURCES_LANGUAGES by PreferenceDelegate_StringSet(setOf("English"))
fun SharedPreferences.SOURCES_LANGUAGES_flow() = toFlow(::SOURCES_LANGUAGES.name) { SOURCES_LANGUAGES }
