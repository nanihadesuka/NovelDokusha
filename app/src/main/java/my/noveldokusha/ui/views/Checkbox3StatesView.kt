...
import my.noveldokusha.reader.databinding.ViewCheckboxBinding
...
class Checkbox3StatesView : FrameLayout {
    ...
    enum class STATE { NONE, POSITIVE, NEGATIVE }
    ...
    private fun updateButtonState(): Unit = when (state) {
        ...
        STATE.NEGATIVE -> Pair(
            R.drawable.ic_twotone_indeterminate_check_box_24,
            R.attr.negativeStateTint
        )
