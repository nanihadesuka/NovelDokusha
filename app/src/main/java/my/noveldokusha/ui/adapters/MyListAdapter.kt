...
abstract class MyListAdapter<T : Any, VH : RecyclerView.ViewHolder> : RecyclerView.Adapter<VH>() {
    ...
    val listDiffer: AsyncListDiffer<T> = AsyncListDiffer(this, object : DiffUtil.ItemCallback<T>() {
        override fun areItemsTheSame(oldItem: T, newItem: T) =
            this@MyListAdapter.areItemsTheSame(oldItem, newItem)

        override fun areContentsTheSame(oldItem: T, newItem: T) =
            this@MyListAdapter.areContentsTheSame(oldItem, newItem)
    })
